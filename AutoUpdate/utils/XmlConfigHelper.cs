...
namespace AutoUpdate.utils
{
    ...
    public class XmlConfigHelper
    {
        ...
        public static string GetValueByKey(string key)
        {
            ...
            {
                UpdateLog.WriteLogLine("读取config.xml：根据key获取value 异常:" + e.ToString());
            }
            finally
            {
                if (xReader != null) {
        ...
        public static void SetValueByKey(String configName, string keyName, string keyValue)
        {
            ...
            {
                UpdateLog.WriteLogLine(configName + "属性保存失败：" + e.ToString());
        ...
        public static List<VersionInfo> GetVersionInfos(String configName)
        {
            ...
            {
                UpdateLog.WriteLogLine("更新软件-----解析“" + configName + "”异常:" + e.ToString());
                throw e;
            }
            return list;
        }
